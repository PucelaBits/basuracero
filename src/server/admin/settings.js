...
const SETTING_DEFINITIONS = {
  ...
  WHATSAPP_SHARE_RECIPIENT_NAME: { fallback: () => process.env.VITE_WHATSAPP_SHARE_RECIPIENT_NAME || 'Ayuntamiento', maxLength: 80 },
...
const SETTING_SECTIONS = {
  ...
  whatsapp: [
    'WHATSAPP_SHARE_ENABLED', 'WHATSAPP_SHARE_PHONE', 'WHATSAPP_SHARE_RECIPIENT_NAME', 'WHATSAPP_REQUIRE_ACTIVATION',
